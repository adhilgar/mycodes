...
void myText(Double_t x,Double_t y,Color_t color,char *text, double tsize ) {
...
void myTextBold(Double_t x,Double_t y,Color_t color,char *text,Double_t tsize ) {
...
void myLineText(Double_t x, Double_t y,Double_t boxsize,Int_t mcolor,char *text, int style) 
{
