...
MyTypeOf::usage="TypeOf[\[ScriptE]\[ScriptX]\[ScriptP]\[ScriptR]] gives the type of \[ScriptE]\[ScriptX]\[ScriptP]\[ScriptR]."
...
MyTypeOf[expr_]:=First[TypeX[Unevaluated[expr]]];
...
TypeBelowQ[a_,t_]:=MatchQ[MyTypeOf[Unevaluated[a]],TypesBelow[t]];
