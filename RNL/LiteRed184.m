...
Input file timestamp: "<>DateString[FileDate[$InputFileName]]<>"\nSee ?LiteRed`* for a list of functions. "];
...
Hold[MyTypeOf[#]===#2,Declare[#,#2]]&@@@({#,MyTypeOf[#]}&/@Select[Variables[l],AtomQ]),
...
(jsm=sec->First@#;
Do[
sol=Solve[0==GroebnerBasis[dmatr[[k,Last@pnf]]-(PadRight[PadLeft[{1},#],Length@ds2+1]&/@Last@#),Flatten[cs]],Flatten[cs]];
Function[sr,
